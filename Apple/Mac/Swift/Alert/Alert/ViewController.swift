            ...
            VStack {
                HStack {
                    ...
                    Button("Black Alert") {
                        ...
                        playSound(source: self.StoreDrive.altStatus - 1)
                    }.foregroundColor(Color.init(red: 0, green: 1, blue: 1, opacity: 1)).fixedSize().padding()
                }.padding().padding()
