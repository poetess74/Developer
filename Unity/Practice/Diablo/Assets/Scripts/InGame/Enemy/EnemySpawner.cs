    ...
    public class EnemySpawner : MonoBehaviour {
        ...
        public bool RemoveEnemy() {
            ...
            if(delFailCount != enemiesCount) {
                Debug.LogWarningFormat("patcher: Can not remove enemies (failed: {0:F2}%). because they are currently immune state. but some enemies will remove in 10 seconds.", failureRatio);
            }
